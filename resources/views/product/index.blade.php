                                ...
                                <tr class="border-2 border-black">
                                    ...
                                    <td class="text-center border-2 border-black">
                                        <form action="{{ route('add.cart') }}" method="POST">
                                            ...
                                            <input type="number" name="quantity" class="w-24">
                                            <button type="submit" class="bg bg-green-700 hover:bg-green-600 px-2 rounded text-white">Add to Cart</button>
                                        </form>
                                    </td>
                                    <td class="text-center border-2 border-black">
                                        <a href="#" data-id="{{ $product->id }}" class="modal-open bg bg-green-700 hover:bg-green-600 px-2 rounded text-white">Updatet</a>
                                    </td>
                                    @if (Auth::user()->hasRole('Admin'))
                                        <td>
